...
public class ItemData {
    ...
    /*
    public ItemData(string id, string name, Texture texture, Vector2 uv, EnumAction action, int stack, int durability) {
        textualID = id;
        itemName = name;
    ...
    */
    ...
    /*
    public ItemData(string id, string name, Texture texture, Vector2 uv, EnumAction action, int stack) {
        textualID = id;
        itemName = name;
