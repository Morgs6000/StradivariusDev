...
public class Item : MonoBehaviour, IPointerDownHandler, IPointerEnterHandler, IPointerExitHandler {
    ...
    public EnumSlotTag enumSlotTag = EnumSlotTag.NONE;
    ...
    public void InitialiseItem(ItemData itemData, int id) {
        ...
        enumSlotTag = itemData.enumSlotTag;
    ...
    public void OnPointerEnter(PointerEventData eventData) {
        ...
        if(enumAction == EnumAction.USE) {
            content = "\n" + "Durability: " + durability + " / " + ItemManager.items[itemID].maxDurability;
        }
        else {
            content = null;
        }

        tooltip.Show(itemName, content, textualID);
    }
